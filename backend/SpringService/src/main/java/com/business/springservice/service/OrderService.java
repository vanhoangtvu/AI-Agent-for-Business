...
public class OrderService {
    ...
    public void cancelOrder(Long orderId, Long customerId) {
        ...
        if (order.getStatus() != OrderStatus.PENDING && 
            ...
            throw new RuntimeException("Chỉ có thể hủy đơn hàng đang chờ xử lý hoặc đã xác nhận. Trạng thái hiện tại: " + order.getStatus());
        }
    ...
    public OrderDTO updateShippingAddress(Long orderId, Long customerId, String newAddress) {
        ...
        if (order.getStatus() != OrderStatus.PENDING && 
            order.getStatus() != OrderStatus.CONFIRMED) {
            throw new RuntimeException("Chỉ có thể cập nhật địa chỉ khi đơn hàng đang chờ xử lý hoặc đã xác nhận. Trạng thái hiện tại: " + order.getStatus());
        }
