...
public class UserController {
    ...
    @Operation(
        ...
        description = "Retrieve a list of all users. Requires ADMIN or BUSINESS role. BUSINESS only sees CUSTOMER users."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Retrieve user details by ID. Requires ADMIN or BUSINESS role."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Create a new user. Requires ADMIN or BUSINESS role."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        summary = "Update user", 
        description = "Update user information. Requires ADMIN or BUSINESS role."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Update user account status (ACTIVE, INACTIVE, SUSPENDED, BANNED). Only ADMIN or BUSINESS role."
    )
    @ApiResponses(value = {
    ...
    @Operation(
        ...
        description = "Update user role (ADMIN, BUSINESS, CUSTOMER). Only ADMIN can use this."
    )
    @ApiResponses(value = {
